...
export default function NovaPousadaPage() {
  ...
  return (
    <main className="min-h-screen px-5 py-8 max-w-lg mx-auto" style={{ background: '#F0F7F2' }}>
      ...
      <h1 className="text-2xl font-bold mb-1" style={{ color: '#1A2E25' }}>Nova pousada</h1>
      ...
      <div className="space-y-4">
        <div className="bg-white rounded-3xl p-5" style={{ border: '1.5px solid #D4EDE0' }}>
          <label className="block text-sm font-medium mb-2" style={{ color: '#1A2E25' }}>Nome da pousada</label>
        ...
        <div className="bg-white rounded-3xl p-5" style={{ border: '1.5px solid #D4EDE0' }}>
          <div className="flex items-center justify-between mb-4">
            <p className="font-medium text-sm" style={{ color: '#1A2E25' }}>Total de quartos</p>
            <span className="font-bold text-lg" style={{ color: '#128C7E' }}>{totalQuartos}</span>
          </div>
        ...
        <div className="bg-white rounded-3xl px-5 pb-2" style={{ border: '1.5px solid #D4EDE0' }}>
          <p className="font-semibold text-base pt-5 mb-1" style={{ color: '#1A2E25' }}>Hóspedes típicos por noite</p>
          <p className="text-sm pb-2" style={{ color: '#5A7A68' }}>Média de ocupação base para o cardápio</p>
        ...
        <div className="bg-white rounded-3xl p-5" style={{ border: '1.5px solid #D4EDE0' }}>
          <p className="text-sm font-medium mb-3" style={{ color: '#1A2E25' }}>Refeições incluídas na diária</p>
        ...
        <div className="bg-white rounded-3xl p-5" style={{ border: '1.5px solid #D4EDE0' }}>
          <p className="text-sm font-medium mb-3" style={{ color: '#1A2E25' }}>Valor da diária (para CMV)</p>
